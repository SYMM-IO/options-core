...
//     /// @notice Sets signer
//     /// @param _signer Address of the new singer
...
//     /// @notice Validates the signature for given data.
//     /// @dev This is a simplified implementation using ECDSA signature recovery.
//     /// It assumes that the signature is produced off-chain using the owner's private key.
...
//         assembly {
//             r := calldataload(add(_signature.offset, 0x20))
//             s := calldataload(add(_signature.offset, 0x40))
//             v := byte(0, calldataload(add(_signature.offset, 0x60)))
//         }
