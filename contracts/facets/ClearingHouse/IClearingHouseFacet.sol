...
interface IClearingHouseFacet is IClearingHouseEvents {
	...
	function liquidateIsolatedPartyB(uint256 liquidationId, address partyB, address collateral, int256 upnl, uint256 collateralPrice) external;
	...
	// Common actions
	function closeTrades(uint256 liquidationId, uint256[] memory tradeIds, uint256[] memory prices) external;
